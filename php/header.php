...
<div class="row noMargin">
  ...
  <div class="col-lg-6">
    <a href="javascript:void(0);" type="button" class="animated fadeInLeft pull-right" onclick="abrirCarrito();" style="margin-right: 20px;"><img class="img-center" src="./img/item-producto/mi-carrito.png" alt="" style="width: 25px;margin-top: 5px;"><span class="cantidad-productos cantProds">0</span></a> 
