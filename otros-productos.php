...
<html lang="es">
 ...
 <div class="col-lg-1 noPadding"></div>
                     <div class="col-sm-6 noPadding">
                        <div class="img-producto" style="background-image:url(./img/otros-productos/roller-dual.jpg);"></div>
                     </div>
...
Estas Cortinas son Ideales para ambientes como Living, Comedor, Salas de Reunión y Oficinas.</p>
 ...
 <div class="col-lg-1 noPadding"></div>
                     <div class="col-sm-6 noPadding">
                                                <div class="img-producto" style="background-image:url(./img/otros-productos/doble-sistema.jpg);"></div>
                     </div>
                     <div class="col-sm-4 pad25">
